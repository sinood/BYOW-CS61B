...
public class TERenderer {
    ...
    public void displayHUDText(HUD hud) {
        clearHUDText(hud);
        hud.updateBelowMouseText(xOffset, yOffset);
        StdDraw.setFont(new Font("Arial", Font.PLAIN, 16));
        StdDraw.textLeft(3, 1.5, "Tile: " + hud.getBelowMouseText());
        StdDraw.textRight(width - 3, 1.5, "Toggle Light (U), Save & Quit (:Q)");

    }

    public void clearHUDText(HUD hud) {
        StdDraw.setPenColor(Color.black);
        StdDraw.filledRectangle(width / 2, 0, width / 2, 3);
        StdDraw.setPenColor(Color.white);
    }
    ...
    public void displaySeedPrompt() {
        StdDraw.setFont(new Font("Arial", Font.PLAIN, 28));
        StdDraw.text(width / 2, height / 2 - 9, "Type in a seed, then press S to generate the world!");
    }
}
